...
<main>
    <div class="width">
        ...
        <div class="a controller table">
            <h2>Performances</h2>
            <?php
            $result = mysqli_query($pdo, "SELECT perf.concertID, perf.startTime, perf.endTime, act.name FROM performance AS perf INNER JOIN act ON perf.actID = act.actID") or die("<p><strong>PHP Info: </strong>Abfrage war nicht möglich.</p>");
